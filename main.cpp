...
int main() {
    ...
    case 1: {
        ...
        case 1: {
            ...
            if (simounao == 'N' || simounao == 'n') {
                ...
                //escreve o valor total dos pedido no arquivo pedido.txt
        ...
        case 2: {
            ...
            if (total == 0)
            {
                //caso valor do carrinho seja igual a zero nao tem aba pagamento
                std::cout << "\n***Aplicacao Encerrada***\n" << std::endl;
            }
            else
            {
                ...
                while (wh)
                {
                    try
                    {
                        ...
                        else if (op_pagamento == 'B' || op_pagamento == 'b')
                        {
                            ...
                            //abre o arquivo pedido que é gerado no final do carrinho
                            std::ifstream arquivoEntrada("pedido.txt");
                            //arquivo que vai ter as informacões do pedido o valor total e a forma de pagamento
                            std::ofstream arquivoSaida("arquivo_saida.txt");
                            std::string linha;
                            //copia todos dados do pedido.txt para o arquivo_saida.txt
        ...
        std::cout << "Esta precisando entrar em contato ?\n";
        std::cout << "\nO que deseja fazer?\nDigite 1 - Central de Ajuda | Digite 2 - Contato Financeiro | Digite 3 - Encerrar programa ";
        int contato;
        ...
        try {
            ...
            case 2://Contato Financeiro
            {
                ...
                contato->ExibirContato();
                std::cout << "\n****Preencha Seus Dados Para o Orcamento*****\n";
                ...
                //escreve cada item e sua qtd no arquivo
                file << "Items:\n";
            ...
            case 3: // case para encerrar o programa
            {
                break;
            }
            default:
    ...
    case 2: {
        //para entrar na aba adm precisa ter username e senha
        using namespace std;
        const string USERNAME = "admin";
        const string PASSWORD = "123456";

        bool w = true;
        //loop que roda ate acetar a senha do usuario
        while (w)
        {
            cout << "Enter username: ";
            string username;
        ...
        std::cout << "1 - Adicionar Produtos | 3 - Sair: ";
        std::cin >> resposta;
